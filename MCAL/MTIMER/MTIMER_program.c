...
static void mtimer_start(u8_t au8_timerChannel)
{
    ...
    switch(au8_timerChannel)
    {
        ...
        case TIMER_CHANNEL_2:
            ...
            /*Setting the timer2 prescaler and start its operation*/
...
void GenerateDesierdFrequency(u16_t top_num, u16_t Ov_flow)
{
    MTIMER_TCCR1 |= TIMER1_FASTPWM_MODE;
    MTIMER_ICR1 = top_num;
    MTIMER_TCNT1 = 0;
    MTIMER_OCR1A = Ov_flow;
